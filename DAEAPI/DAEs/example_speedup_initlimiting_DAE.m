function DAE = example_speedup_initlimiting_DAE(uniqIDstr)  % DAEAPIv7
%function DAE = example_speedup_initlimiting_DAE(uniqIDstr)  % DAEAPIv7
...
%Changelog:
%---------
%2014/08/27: Tianshi Wang <tianshi@berkeley.edu>: moved to be
%            example_speedup_initlimiting_DAE
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% CORE FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fout, qout] = fq(x, xlim, flag, DAE)
    if 3 == nargin 
        DAE = flag;
		flag = xlim;
