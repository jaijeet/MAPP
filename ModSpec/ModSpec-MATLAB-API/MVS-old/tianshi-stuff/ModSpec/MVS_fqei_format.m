function MOD = MVS_fqei_format(uniqID)
% 1.0.1.5, put in fqei field
% f is separated
...
% Core functions: qi, fi, qe, fe: 
	...
	MOD.fqei = @fqei; % qe(vecX, vecY, MOD)
...
function [feout, fiout, qeout, qiout] = fqei(vecX, vecY, vecLim, u, MOD)
	...
	% KCL at g
	qeout(2,1) = qgb; % TODO: vecvalder trick...
	% KCL at d
	qeout(1,1) = 0;
	% KCL at s
	qeout(3,1) = 0;
	...
	% KCL at di
	fiout(1,1) = idisi - iddi;
	% KCL at si
	fiout(2,1) = isis - idisi;
