function test = STA_vsrc_diode_transient()
    ...
    test.DAE = DAE;
    test.name = 'STA_vsrc_diode_tran'; % Type of analysis
    test.analysis = 'transient'; % Type of analysis
    test.refFile = 'STA_vsrc_diode_tran.mat';

    % Simulation time-related parameters
    test.args.xinit = zeros(DAE.nunks(DAE),1);
