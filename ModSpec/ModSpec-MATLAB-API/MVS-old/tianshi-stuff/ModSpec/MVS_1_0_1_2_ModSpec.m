function MOD = MVS_1_0_1_2_ModSpec(uniqID)
% fetlim is added without considering Rs, Rd
% This is most likely how fetlim is applied to MVS in HSPICE/Spectre
% f is separated
...
% Tianshi: smoothing = 1e-5
	...
	MOD.vecXY_to_limitedvars_matrix = [eye(3), zeros(3, 2)];
...
function fqout = fqei(vecX, vecY, vecLim, u, MOD, forq, eori)
	...
	vdblim = vecX(1); vgblim = vecX(2); vsblim = vecX(3);
