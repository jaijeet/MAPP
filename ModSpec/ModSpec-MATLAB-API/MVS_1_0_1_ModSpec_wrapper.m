function MOD = MVS_1_0_1_ModSpec_wrapper(uniqID)
%function MOD = MVS_1_0_1_ModSpec_wrapper(uniqID)
...
%
	...
	MOD = add_to_ee_model (MOD, 'modelname', 'MVS_1_0_1_wrapper');
	MOD = add_to_ee_model (MOD, 'description', 'DAA/Shaloo''s MVS v1.0.1, translated to ModSpec from Verilog-A.');
...
function limitedvarout = initGuess(S)
    ...
    limitedvarout(2, 1) = Type * Vt0;  % vgblim 
...
function limitedvarout = limiting(S)
    ...
    limitedvarout(2, 1) = vgs - vbs; % vgb %vecvalder trick...
