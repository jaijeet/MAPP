function DAE = exampleDAE() 
%function DAE = exampleDAE()
%This is an example to illustrate how to set up a DAE.
...
%Changelog:
%---------
%2016/02/28: Jaijeet Roychowdhury <jr@berkeley.edu>: updated help documentation
%2014/07/27: Tianshi Wang <tianshi@berkeley.edu>: renamed as exampleDAE
...
function fout = f(x, DAE)
    ...
    fout(1,1) = - feval(diod.f, -vC, Is, Vt) + (vC-v2)/R; % nC KCL
...
function Jf = df_dx(x, DAE)
    ...
    [Id, Jf(1,1)] = feval(diod.f, -vC, Is, Vt);
    Jf(1,1) = Jf(1,1) + 1/R;
    Jf(1,2) = -1/R;
