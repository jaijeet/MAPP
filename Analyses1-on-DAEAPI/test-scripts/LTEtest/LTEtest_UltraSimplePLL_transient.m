function LTEtest_UltraSimplePLL_transient(tstep)
...
%
	...
	% run the simulation
	tic
    BEobj.tranparms.LTEstepControlParms.doStepControl=0;
    ...
    tic
    BEobj.tranparms.LTEstepControlParms.doStepControl=1;
    BEobj = feval(BEobj.solve, BEobj, xinit, tstart, tstep, tstop);
    fprintf('BE_LTE\n');
    toc
