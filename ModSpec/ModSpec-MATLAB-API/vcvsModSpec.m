function MOD = vcvsModSpec(uniqID)
%function MOD = vcvsModSpec(uniqID)
%This function returns a ModSpec model for ideal voltage-controlled voltage
%sources.
%
%Arguments:
% - uniqID: (optional) a unique identification string. Eg, 'E1'.
%
%Return values:
% - MOD:    a ModSpec object for a voltage-controlled voltage source.
...
% - explicit output name(s) (vecZ):  ipcnc, vnnc, innc
% - other IO name(s) (vecX):         vpcnc, vpnc, ipnc
...
%    ipcnc = 0
%    gain*vpcnc-vpn = 0  -->  vnnc = -gain*vpcnc + vpnc
%    innc = -ipnc
% - fe = [0;
%        -gain*vpcnc + vpnc;
%        -ipnc];
...
%Examples
%--------
% % adding a vcvs with gain equal to 0.5
% cktdata = add_element(cktdata, vcvsModSpec(), 'E1', ...
...
% uniqID
    ...
    MOD.model_name = 'vcvs';
    MOD.model_description = 'ideal voltage controlled voltage source';
    ...
    MOD.explicit_output_names = {'ipcnc', 'vnnc', 'innc'};
...
end % vcvs MOD constructor

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%% CORE DEVICE EVAL FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fe, qe, fi, qi] = fqei(vecX, vecY, u, flag, MOD)
