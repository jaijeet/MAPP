...
%NOT IMPLEMENTED
%Runs DAE transient sensitivity analysis on SHringosc101_ckt.
...
%if not specified, runs both.
    ...
    load('SHringosc101_ckt_xinit_TRAP_3000pts.mat');
    x0 = xinit;
    DAE.C = @C;
    ...
    file = fopen(strcat(DATA_DIR, 'SHosc101-output-TRAP-6000pts.dat'),'w');
    ...
    file = fopen(strcat(DATA_DIR, 'SHosc101-direct-TRAP-6000pts.dat'),'w');
    pnames = pNom.ParmNames(pNom);
    fprintf(file, 't');
    ...
    file = fopen(strcat(DATA_DIR, 'SHosc101-adjoint-TRAP-6000pts.dat'),'w');
