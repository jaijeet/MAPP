...
%Test script to generate characteristic curves of an MVS MOSFET model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
title 'NFET with d/s resistors: blue: ModSpec/DAEAPI, red: IEDM05 measurement';
grid on; axis tight;
...
grid on; axis tight;
title 'PFET with d/s resistors: blue: ModSpec/DAEAPI; red: IEDM05 measurement';
