function ok = test_MVS_1_0_1_ModSpec_wrapper(arg)
%function test_MVS_1_0_1_ModSpec_wrapper() or ('update')
% test-script for MVS_1_0_1_ModSpec_wrapper
...
if nargin ~= 0 && strcmp(class(arg), 'char') && strcmp(arg, 'update')
    % update
    [filename, is_new] = run_ModSpec_functions(MOD, 'MVS_1_0_1_ModSpec_wrapper', 'update');
    if is_new
        ...
        % add random test cases for MVS_1_0_1_ModSpec_wrapper
        ref.rtests{1} = 1;
        % save ref
        save(filename, 'ref');
    [filename, is_new] = run_ModSpec_functions(MOD, 'MVS_1_0_1_ModSpec_wrapper', 'update');
    ...
    % no update
    [filename, is_new, ok] = run_ModSpec_functions(MOD, 'MVS_1_0_1_ModSpec_wrapper');
end
