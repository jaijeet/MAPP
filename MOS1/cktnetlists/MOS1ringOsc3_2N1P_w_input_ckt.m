function cktnetlist = MOS1ringOsc3_2N1P_w_input_ckt()
%function cktnetlist = MOS1ringOsc3_2N1P_w_input_ckt()
...
%   devices. This circuit uses subcircuit MOS1inverter_2N1P.
%   The circuit has 
%
%To see the schematic of this circuit, run:
%
% showimage('MVSringosc3.jpg'); % TODO: update name to MOS1, update to 2N1P
%
%Examples
%--------
%
...
%
% Author: Tianshi Wang, 2014/09/08
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %---------------------------------------------------------------------------
    % ckt name
    subcktnetlist.cktname = 'MOS1 inverter_2N1P';
    ...
    % nmos1Elem
    subcktnetlist = add_element(subcktnetlist, MOS1_Model, 'NMOS1', {'out', 'in', 'gnd', 'gnd'}, ...
    {{'TYPE', 'N'}, ...
     {'CBD', 0.5e-12}, ...
     {'CBS', 0.5e-12}, ...
     {'CGDO', 0.1e-12}, ...
    ...
    % nmos2Elem
    subcktnetlist = add_element(subcktnetlist, MOS1_Model, 'NMOS2', {'out', 'in', 'gnd', 'gnd'}, ...
    {{'TYPE', 'N'}, ...
     {'CBD', 0.5e-12}, ...
     {'CBS', 0.5e-12}, ...
     {'CGDO', 0.1e-12}, ...
    ...
    % Iin
    cktnetlist = add_element(cktnetlist, isrcModSpec, 'Iin', ...
	                            {'inv1', 'gnd'}, {}, {{'I', {'DC', 0}}});
