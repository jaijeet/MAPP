function DAE = vsrcRLCdiode_daeAPIv6(uniqIDstr)  % DAEAPIv6.2
%function DAE = vsrcRLCdiode_daeAPIv6(uniqIDstr)  % DAEAPIv6.2
% vsrc-RLC-diode circuit DAE
...
%2011/09/19: Jaijeet Roychowdhury <jr@berkeley.edu>
...
% version, help string: 
	...
	DAE.Usage = help('vsrcRLCdiode_daeAPIv6');
	if nargin < 1
		DAE.uniqIDstr = '';
	else
