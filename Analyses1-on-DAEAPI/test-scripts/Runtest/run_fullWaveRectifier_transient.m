...
% Test script for running transient analysis on a full Wave rectifier  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xinit = feval(DAE.QSSinitGuess, utargs.A, DAE);
%xinit = zeros(feval(DAE.nunks,DAE),1); breaks both BE and TRAP
tstart = 0;
tstep = 10e-7; tstop = 5e-2; %
...
title(sprintf('BE and GEAR2 on %s', feval(DAE.daename,DAE)));
