...
%
% A 3 stage ring oscillator with DAAv6 MOSFET
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The Circuit: 
...
% ckt name
cktname = 'DAAV6-3stg-ringosc-no-ext-caps';
...
% 	W=1.0e-4 \
minv1pM = feval(minv1pM.setparms,'W', 1.0e-4, minv1pM);
%	Lg=35e-7 \
...
% set up and return a DAE of the MNA equations for the circuit
 DAE = STA_EqnEngine(cktname, circuitdata);
