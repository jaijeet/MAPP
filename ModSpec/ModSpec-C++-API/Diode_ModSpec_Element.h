#ifndef DIODE_MODSPEC_ELEMENT_H
#define DIODE_MODSPEC_ELEMENT_H
#include "ModSpec_Element.h"

class Diode_ModSpec_Element_with_sacado_Jacobians: public ModSpec_Element_with_Jacobians {
	public: 
		Diode_ModSpec_Element_with_sacado_Jacobians();
		~Diode_ModSpec_Element_with_sacado_Jacobians() {};
	protected:
