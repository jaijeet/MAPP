...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	% isyncElem
	cktnetlist = add_element(cktnetlist, isrcModSpec(), 'Isync', {'inv1', 'gnd'}, {}, {{'I',...
	{'DC', 0}}});
