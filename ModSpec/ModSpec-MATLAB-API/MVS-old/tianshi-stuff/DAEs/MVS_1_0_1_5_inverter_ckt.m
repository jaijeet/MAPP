function cktnetlist = MVS_1_0_1_5_inverter_ckt()
%function cktnetlist = MVS_1_0_1_5_inverter_ckt()
...
%
% % DC sweep %
% swp = dot_dcsweep(DAE, [], 'Vin:::E', 0, 5, 20);
% feval(swp.plot, swp);
%
%See also
%--------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % nmosElem
    cktnetlist = add_element(cktnetlist, MVS_1_0_1_5_ModSpec(), 'NMOS', {'out', 'in', 'gnd', 'gnd'}, ...
    ...
    % pmosElem
    cktnetlist = add_element(cktnetlist, MVS_1_0_1_5_ModSpec(), 'PMOS', {'vdd', 'in', 'out', 'vdd'}, ...
