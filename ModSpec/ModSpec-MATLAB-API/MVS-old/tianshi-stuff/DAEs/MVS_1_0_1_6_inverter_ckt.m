function cktnetlist = MVS_1_0_1_6_inverter_ckt()
%function cktnetlist = MVS_1_0_1_6_inverter_ckt()
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % nmosElem
    cktnetlist = add_element(cktnetlist, MVS_1_0_1_6_ModSpec(), 'NMOS', {'out', 'in', 'gnd', 'gnd'}, ...
    ...
    % pmosElem
    cktnetlist = add_element(cktnetlist, MVS_1_0_1_6_ModSpec(), 'PMOS', {'vdd', 'in', 'out', 'vdd'}, ...
