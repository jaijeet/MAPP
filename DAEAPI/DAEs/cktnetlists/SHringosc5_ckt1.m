function cktnetlist = SHringosc5_ckt1()
%function cktnetlist = SHringosc5_ckt1()
%This function returns a cktnetlist structure for a ring oscillator
% 
% This is a test for subcircuit support using MNA_EqnEngine_ModSpec
% [TODO] This version is currently not working.
%
%The circuit
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	% subcktnetlist = SHinverter_ckt;
	% subcktnetlist.terminalnames = {'in', 'out'};
	% % 
	% cktnetlist = add_element(cktnetlist, subcktnetlist, 'X1', {'inv1', 'inv2'}, ...
	% {{'NMOS:::Beta', 1.8e-3}, {'NMOS:::VT', 0.3}}, {});

	inverter = SHinverter_ckt;
	inverter.terminalnames = {'in', 'out'};
	inverter.issubckt = 1; % TODO: get rid of this
	% X1Elem
	cktnetlist = add_element(cktnetlist, inverter, 'X1', {'inv5', 'inv1'}, {}, {});

	% X2Elem
	cktnetlist = add_element(cktnetlist, inverter, 'X2', {'inv1', 'inv2'}, {}, {});

	% X3Elem
	cktnetlist = add_element(cktnetlist, inverter, 'X3', {'inv2', 'inv3'}, {}, {});

	% X4Elem
	cktnetlist = add_element(cktnetlist, inverter, 'X4', {'inv3', 'inv4'}, {}, {});

	% X5Elem
	cktnetlist = add_element(cktnetlist, inverter, 'X5', {'inv4', 'inv5'}, {}, {});
