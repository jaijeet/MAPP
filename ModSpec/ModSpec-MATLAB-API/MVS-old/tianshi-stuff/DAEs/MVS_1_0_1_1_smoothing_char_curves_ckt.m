function cktnetlist = MVS_1_0_1_1_smoothing_char_curves_ckt()
	% ckt name
	...
	% mosElem
	cktnetlist = add_element(cktnetlist, MVS_1_0_1_1_ModSpec(), 'NMOS', {'drain', 'gate', 'gnd', 'gnd'}, {{'smoothing', 1e-18}});
end
