...
%Changelog:
%---------
%2014/08/20: Tianshi Wang <tianshi@berkeley.edu>: moved to be
%            example_speedup_DAE
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% CORE FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fout, qout] = fq(x, flag, DAE)
