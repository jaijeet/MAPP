function MOD = example_initlimiting_ModSpec(uniqID)
%function MOD = example_initlimiting_ModSpec(uniqID)
...
function fqout = fqei(vecX, vecY, vecLim, vecU, MOD, forq, eori)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % set up scalar variables for the parms, vecX, vecY, vecLim and vecU
