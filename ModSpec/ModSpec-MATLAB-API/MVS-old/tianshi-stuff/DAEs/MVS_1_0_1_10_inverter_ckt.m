function cktnetlist = MVS_1_0_1_10_inverter_ckt()
%function cktnetlist = MVS_1_0_1_10_inverter_ckt()
...
%
% % set up DAE %
% DAE = MNA_EqnEngine(MVS_1_0_1_10_inverter_ckt);
%
% % DC sweep %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % nmosElem
    cktnetlist = add_element(cktnetlist, MVS_1_0_1_10_ModSpec(), 'NMOS', {'out', 'in', 'gnd', 'gnd'}, ...
    ...
    % pmosElem
    cktnetlist = add_element(cktnetlist, MVS_1_0_1_10_ModSpec(), 'PMOS', {'vdd', 'in', 'out', 'vdd'}, ...
